...
bin/icecore: build/main.o build/cursor.o build/versionindex.o build/mtree.o build/error.o build/utils.o build/filestore.o build/_tree.o build/array.o build/utils.o build/icecore.o build/filestore.o build/md5.o build/cli.o build/document.o bin
	$(LINK) build/main.o build/cursor.o build/versionindex.o build/mtree.o build/error.o build/array.o build/utils.o build/_tree.o build/icecore.o build/filestore.o build/md5.o build/cli.o build/document.o -o bin/icecore
